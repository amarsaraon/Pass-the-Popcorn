...
private var speed = Movie(t: MovieNames.speed.rawValue, y: "1994", g1: "Action", g2: "Thriller", s: "Los Angeles", a1: "Keanu Reeves", a2: "Sandra Bullock", a3: "Dennis Hopper", c1: "Jack Traven", c2: "Annie Porter", c3: "Howard Payne", d: "Jan de Bont", p: "A young police officer must prevent a bomb exploding aboard a city bus by keeping it above 50 mph.", q: "Pop quiz, hotshot. There's a bomb on a bus. Once the bus goes 50 miles an hour, the bomb is armed. If it drops below 50, it blows up. What do you do? What do you do?")
...
private var modernClassics = [backToTheFuture, toyStory, dieHard, bladeRunner, jaws, theMatrix, rocky, homeAlone, alien, raidersOfTheLostArk, theKarateKid, independenceDay, speed]
